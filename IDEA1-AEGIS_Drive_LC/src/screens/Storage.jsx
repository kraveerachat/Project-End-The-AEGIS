...
/* ── จอนี้เคยเป็นแหล่งข้อมูลปลอมที่อันตรายที่สุดในแอป ────────────────────────────────
   ...
   สิ่งที่แสดงตอนนี้:
   - ความจุ: statfs ของ mount ที่ Data Lake อยู่ + ผลรวมตามหมวดจากฐานข้อมูล — แสดงเป็น
     วงแหวนร่วมศูนย์กลางสองฐาน: วงนอกเทียบทั้ง volume และวงในเทียบเฉพาะข้อมูล AEGIS
     ทุกส่วนใช้ความหนาเต็มแต่รักษามุมตามสัดส่วนจริง; legend รับหน้าที่อ่านค่าที่เล็กมาก
