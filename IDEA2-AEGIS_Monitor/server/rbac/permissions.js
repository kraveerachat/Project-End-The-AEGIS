...
const VIEW_REGISTRY = [
  ...
  // ✅ 2026-07-27: component ถูกสร้างแล้ว (src/views/Operators.jsx) และลงทะเบียนใน
  //    src/nav.js + src/App.jsx — entry นี้จึง render เป็นเมนูจริงแล้ว ไม่ถูกทิ้งเงียบ ๆ
  //    อีกต่อไป และเป็นผู้เรียกเดียวของ PUT /api/assignments
