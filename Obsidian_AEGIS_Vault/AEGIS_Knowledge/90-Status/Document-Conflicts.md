...
> **หลักการตัดสิน: ยึดของจริงเป็นความจริง** แล้วแก้เอกสารตาม (ยกเว้นข้อ 3 ที่ต้องเลือกก่อน)
...
### ต้องเลือกหนึ่งทาง ⏳ **ยังไม่ตัดสินใจ**
...
> 💡 **ข้อสังเกตเชิงเทคนิค**: ทางเลือก (ข) แข็งแรงกว่าในเชิงความปลอดภัย เพราะ (ก) แปลว่าให้ทั้ง `/24` ในขณะที่ของจริงตอนนี้ให้แค่ **1 IP 1 port** — การ "แก้ให้ตรงเล่ม" จะทำให้ระบบ**ปลอดภัยน้อยลง**
> อย่างไรก็ตาม VLAN 30 ยังมีบทบาทสำคัญอยู่ในฐานะ **เส้นทางกายภาพที่ยังใช้ได้ตอน Uplink ถูกตัดโดย IDEA3** ([[concepts/Dead_Mans_Switch]]) — สองเรื่องนี้ควรถูกอธิบายแยกกันในเล่ม ไม่ใช่ปนกัน

**สถานะ**: ⏳ **ยังไม่ตัดสินใจ — ต้องคุยกันในทีมก่อน**
...
| 3 | **ต้องผ่าน VLAN 30 ก่อนหรือไม่** | ⏳ **ยังไม่ตัดสินใจ** | ⏳ |
