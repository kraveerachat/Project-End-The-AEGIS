...
volume was created at all** — the data lives in the container's writable layer
and disappears with it. Credentials were generated by the script; no `.env` file
was read and no production credential was printed. `docker compose down`,
