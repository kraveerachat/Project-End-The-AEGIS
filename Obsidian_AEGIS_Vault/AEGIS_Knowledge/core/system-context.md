...
# 🧱 AEGIS Stable System Context

> [!info] Preserved source content
> This file is the complete pre-restructure architecture overview moved in place. [[core/system-overview]] embeds it together with independently owned IDEA status fragments.
