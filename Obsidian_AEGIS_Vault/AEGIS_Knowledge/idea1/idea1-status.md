...
- Current rollout objective: Human Owner review of the hardened second Stage A command set. Exact source `70b0fdf059672e2b1c408ec5e5c16cfed5261257`; candidate `aegis-prod-drive:vault-tree-70b0fdf05967`; image ID `sha256:c97cf9f6e3bdd36b4ecca5471d842a46f151f8ca09edcda0be2084e97c42c673`; OCI revision exact. Image-config user is `node`; disposable runtime evidence is effective user `node`, UID `1000`, GID `1000`. `NEW_CANDIDATE=LOCAL_QUALIFIED`; `SECOND_STAGE_A=PENDING_HUMAN_PRODUCTION_ACTION`.
