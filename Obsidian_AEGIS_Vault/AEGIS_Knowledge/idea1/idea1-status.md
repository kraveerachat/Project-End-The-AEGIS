...
| Current state | **IN PROGRESS — S5.5-A, S5.5-B, S5.5-C and S5.5-D CLOSED / PASS (repository implementation only); S5.5-E through S5.5-H NOT STARTED** |
| Started | 2026-09-11 |
...
bridge resolution is implemented and tested. S5.5-E through S5.5-H remain
**NOT STARTED**.
