...
> **Current production source basis**: ⚠️ Three different SHAs are in play and must not be collapsed. The **Production Git checkout** remains at `2806373bb300728a0babb953a63f98bcd714ffef` (PR #80), which is what delivered PR #79 local Twingate runtime telemetry and PR #80 Vault auto-lock. It is **no longer the source basis of the running Drive application**: since 2026-09-06 that image is built from PR #92 head `64807e963359c6a85bc5d9ded7b6ff1b05226694` (see the PR #92 entry below), while GitHub `main` is the PR #92 merge commit `d4b8e921...`. PR #81 merged the Backup Target classifier source fix at merge milestone `07ad78efdf1561f2a49a1ecc81440359b766b3bd`. On 2026-09-06 the reviewed classifier was deployed **only** to the live Host Backup Agent copy at `/opt/aegis/host-backup-agent/src/targets.js`; the Production Git checkout itself remained `2806373...`. The live classifier blob is `2a9dc27fbdb812dbb50a84d10f364343fc09d967`, `PrivateDevices=yes` was preserved, and Production accepted `hgst-usb-1 → DIFFERENT_DEVICE`.
