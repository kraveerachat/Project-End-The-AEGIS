...
- State: **IN PROGRESS / SECOND STAGE A ROLLED BACK / DATA GATE CORRECTION UNDER REVIEW**.
...
- Current rollout objective: Human review of the corrected protected-data fingerprint before any Third Stage A. Exact source `70b0fdf059672e2b1c408ec5e5c16cfed5261257`; candidate `aegis-prod-drive:vault-tree-70b0fdf05967`; image ID `sha256:c97cf9f6e3bdd36b4ecca5471d842a46f151f8ca09edcda0be2084e97c42c673`; OCI revision exact. Image-config user is `node`; disposable runtime evidence is effective user `node`, UID `1000`, GID `1000`. No rebuild is required or authorized. `THIRD_STAGE_A=NOT_AUTHORIZED`.
